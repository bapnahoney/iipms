...
public class DispatchClearance : CreationAuditedEntity<long>
{
    public DispatchClearance()
    {
    ...
    public virtual ICollection<DCData> DCData { get; set; }
    public virtual POMaster POMaster { get; set; }
    public virtual ICollection<DCDocument> DCDocuments { get; set; }
}

public partial class DCData : CreationAuditedEntity<long>
{
    public long DispatchClearanceId { get; set; }
    [ForeignKey("DispatchClearanceId")]
    public long POMasterId { get; set; }
    [ForeignKey("POMasterId")]
    ...
    public virtual DispatchClearance DispatchClearance { get; set; }
    public virtual POMaster POMaster { get; set; }
}
public partial class DCDocument : CreationAuditedEntity<long>
{
    public long DispatchClearanceId { get; set; }
    [ForeignKey("DispatchClearanceId")]
