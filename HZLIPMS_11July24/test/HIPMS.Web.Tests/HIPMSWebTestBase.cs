...
{
    public abstract class HIPMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HIPMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HIPMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HIPMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HIPMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HIPMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HIPMSDbContext, Task<T>> func)
        {
            T result;
